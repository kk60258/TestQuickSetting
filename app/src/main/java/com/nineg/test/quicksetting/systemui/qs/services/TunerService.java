 ...
 */
package com.nineg.test.quicksetting.systemui.qs.services;
...
import com.nineg.test.quicksetting.systemui.model.QSTileModel;
...
//        mCurrentUser = ReflectionUtils.activityManager_getCurrentUser();
...
//        }
    ...
    public String getValue(String setting) {
        return QSTileModel.getString(mContentResolver, setting);
    }

    public void setValue(String setting, String value) {
        QSTileModel.putString(mContentResolver, setting, value);
    }

    public int getValue(String setting, int def) {
        return QSTileModel.getInt(mContentResolver, setting, def);
    }

    public void setValue(String setting, int value) {
        QSTileModel.putInt(mContentResolver, setting, value);
    }
...
//            mContentResolver.registerContentObserver(uri, false, mObserver, mCurrentUser);
        ...
        String value = QSTileModel.getString(mContentResolver, key);
