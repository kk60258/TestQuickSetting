...
import com.nineg.test.quicksetting.systemui.qs.utils.FontSizeUtils;
...
public class QSTileView extends QSTileBaseView {
    ...
    private void updateTopPadding() {
        ...
        float largeFactor = (constrain(getResources().getConfiguration().fontScale,
    ...
    protected void handleStateChanged(QSTile.State state) {
        ...
        if (!TextUtils.equals(mLabel.getText(), state.label)) {
