...
//import static com.nineg.test.quicksetting.systemui.qs.utils.RestrictedLockUtils.EnforcedAdmin;
 ...
 */
public abstract class QSTile<TState extends QSTile.State> {
...
//        MetricsLogger.action(mContext, MetricsEvent.View.ACTION_QS_LONG_PRESS.getNumber(), getTileSpec());
...
//                userRestriction, ReflectionUtils.activityManager_getCurrentUser());
